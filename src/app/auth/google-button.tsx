...
export default function GoogleButton({ label = 'Continue with Google' }: { label?: string }) {
  ...
  return (
    <button
      ...
      onClick={handleClick}
      disabled={loading}
      className="flex w-full items-center justify-center gap-3 rounded-full border border-[#d4ede0] bg-white py-3 text-sm font-semibold text-[#1e2a27] shadow-sm transition hover:bg-[#f4faf7] disabled:opacity-60"
    >
